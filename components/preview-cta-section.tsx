...
export default function PreviewCTASection({ realtor }: { realtor: Realtor }) {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            {realtor.firstName} is here to help you every step of the way in {realtor.address}. Choose your preferred
            method of contact and let's start your real estate journey today.
          </motion.p>
        </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-lg font-bold text-gray-900">WhatsApp {realtor.firstName} Now</p>
              </div>
              <motion.div
                className="ml-4"
                animate={{ x: [0, 5, 0] }}
